...
class LiqHeatMapCurrencyModel1(AsyncSpider):
    name = "liq_heat_map_currency_model_1"
    script_type = "async"
    log = None
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.url = f"{self.domin}/api/index/aggregate/liqHeatMap"
        self.headers = {
    ...
    @auto_execute_method()
    async def liq_heat_map_currency_model_1(self):
...
if __name__ == '__main__':
    kw = {
        "extra_params": {
            "sem": 3,
            "domin": "https://gas.cg-app-api.com",
            "currencies": [
                "BTC"
            ],
            "time_interval": [
    ...
    asyncio.run(async_func_test(LiqHeatMapCurrencyModel1, kw))
